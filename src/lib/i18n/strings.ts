...
export const strings = {
  ...
  resortPage: {
    ...
    feelsLike: createText({ ko: "체감", en: "Feels like", ja: "体感" }),
    sort: createText({ ko: "정렬", en: "Sort", ja: "並び替え" }),
    sortName: createText({ ko: "이름순", en: "Name (A→Z)", ja: "名前順" }),
    sortMostWebcams: createText({ ko: "웹캠 많은 순", en: "Most webcams", ja: "ライブカメラ多い順" }),
    sortMostSlopes: createText({ ko: "슬로프 많은 순", en: "Most slopes", ja: "コース多い順" }),
